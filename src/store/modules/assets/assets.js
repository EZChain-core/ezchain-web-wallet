...
var assets_module = {
    ...
    actions: {
        ...
        onUtxosUpdated: function (_a) {
            var state = _a.state, dispatch = _a.dispatch, rootState = _a.rootState;
            return __awaiter(this, void 0, void 0, function () {
                var wallet;
                return __generator(this, function (_b) {
                    switch (_b.label) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    for (i = 0; i < tokens.length; i++) {
                        t_1 = tokens[i];
                        if (token.address === t_1.data.address && token.chainId === t_1.data.chainId) {
        ...
        addCustomErc20Token: function (_a, token) {
            var state = _a.state, rootState = _a.rootState, commit = _a.commit;
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    for (i = 0; i < tokens.length; i++) {
                        t_2 = tokens[i];
                        if (token.address === t_2.data.address && token.chainId === t_2.data.chainId) {
                            throw new Error('ERC20 Token already added.');
                        }
                    }
                    t = new Erc20Token(token);
        ...
        addTokenListUrl: function (_a, data) {
            var dispatch = _a.dispatch, state = _a.state, commit = _a.commit;
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (state.tokenListUrls.includes(data.url))
                                throw 'Already added.';
                            if (state.tokenListsCustom.includes(data.url))
                                throw 'Already added.';
                            url = data.url;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, dispatch('addTokenListUrl', {
                                    url: TOKEN_LISTS[i],
                                    readonly: true,
                                })];
                        case 3:
        ...
        addUnknownAssets: function (_a) {
            var state = _a.state, getters = _a.getters, rootGetters = _a.rootGetters, dispatch = _a.dispatch;
        ...
        updateUTXOs: function (_a) {
            var state = _a.state, commit = _a.commit, dispatch = _a.dispatch, rootState = _a.rootState;
            return __awaiter(this, void 0, void 0, function () {
                var wallet;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!(wallet.type === 'ledger' || wallet.type === 'mnemonic')) return [3 /*break*/, 2];
                            return [4 /*yield*/, wallet.updateUTXOsExternal()];
                        case 1:
                            _b.sent();
                            return [3 /*break*/, 4];
                        case 2: return [4 /*yield*/, wallet.updateUTXOsX()];
                        case 3:
                            _b.sent();
                            _b.label = 4;
                        case 4:
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    tokens.forEach(function (token) {
                        if (token.data.chainId !== networkID)
                            return;
        ...
        updateAvaAsset: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, avm.getAssetDescription('EZC')];
                        case 1:
                            res = _b.sent();
            ...
            for (var n = 0; n < addrUtxos.length; n++) {
                ...
                if (locktime.lte(unixNox)) {
                    if (!dict[assetId]) {
                        ...
                        var amt = dict[assetId].available;
        ...
        addUnknownAsset: function (_a, assetId) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, ava.XChain().getAssetDescription(assetId)];
                        case 1:
                            desc = _b.sent();
                            newAsset = new AvaAsset(assetId, desc.name, desc.symbol, desc.denomination);
    ...
    getters: {
        ...
        findErc20: function (state) { return function (contractAddr) {
            var tokens = state.erc20Tokens.concat(state.erc20TokensCustom);
            for (var i = 0; i < tokens.length; i++) {
                var t = tokens[i];
