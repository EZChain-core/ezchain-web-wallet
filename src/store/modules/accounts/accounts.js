    ...
    actions: {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (
                                !pass ||
                                (wallet_1 === null || wallet_1 === void 0
                                    ? void 0
                                    : wallet_1.type) === 'ledger'
                            )
                                return [2 /*return*/]
                            ...
                            encryptedWallet = {
                                ...
                                name:
                                    (activeAccount === null || activeAccount === void 0
                                        ? void 0
                                        : activeAccount.name) || data.accountName,
                                wallet: file,
                            }
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!account || !index) return [2 /*return*/]
        ...
        deleteKey: function (_a, wallet) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    if (!getters.account) return [2 /*return*/]
