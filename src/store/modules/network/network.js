...
var network_module = {
    ...
    actions: {
        ...
        saveSelectedNetwork: function (_a) {
            var _b;
            var state = _a.state;
            var data = JSON.stringify((_b = state.selectedNetwork) === null || _b === void 0 ? void 0 : _b.url);
        ...
        load: function (_a) {
            ...
            if (data) {
                ...
                networks.forEach(function (n) {
                    var newCustom = new AvaNetwork(n.name, n.url, 
                    //@ts-ignore
                    parseInt(n.networkId), n.explorerUrl, n.explorerSiteUrl, n.readonly);
                    dispatch('addCustomNetwork', newCustom);
                });
            }
        },
        setNetwork: function (_a, net) {
            var state = _a.state, dispatch = _a.dispatch, commit = _a.commit, rootState = _a.rootState;
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            ...
                            web3Provider = net.protocol + "://" + net.ip + ":" + net.port + "/ext/bc/C/rpc";
                            web3.setProvider(web3Provider);
                            // Set socket connections
                            setSocketNetwork(net);
                            commit('Assets/removeAllAssets', null, { root: true });
                            return [4 /*yield*/, dispatch('Assets/updateAvaAsset', null, { root: true })
                                // If authenticated
                            ];
                        case 5:
                            _b.sent();
                            ...
                            return [4 /*yield*/, dispatch('Assets/onNetworkChange', net, { root: true })];
                        case 6:
                            _b.sent();
                        ...
                        case 7:
                            sdkNetConf = _b.sent();
                            return [4 /*yield*/, Network.setNetworkAsync(sdkNetConf)
        ...
        updateTxFee: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, infoApi.getTxFee()];
                        case 1:
                            txFee = _b.sent();
        ...
        init: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            mainnet = new AvaNetwork('EZChain MainNet', 'https://api.ezchain.com:443', 1, 'https://index-api.ezchain.com', 'https://explorer.ezchain.com', true);
                            fuji = new AvaNetwork('EZChain Testnet', 'https://testnet-api.ezchain.com:443', 5, 'https://testnet-index-api.ezchain.com', 'https://testnet-explorer.ezchain.com', true);
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, , 4]);
