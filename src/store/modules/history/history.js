...
var history_module = {
    ...
    actions: {
        updateTransactionHistory: function (_a) {
            var state = _a.state, rootState = _a.rootState, rootGetters = _a.rootGetters, dispatch = _a.dispatch;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            limit = 20;
                            return [4 /*yield*/, getAddressHistory(avmAddrs, limit, avm.getBlockchainID())];
                        case 1:
                            txs = _b.sent();
                            return [4 /*yield*/, getAddressHistory(pvmAddrs, limit, pChain.getBlockchainID())];
                        case 2:
                            txsP = _b.sent();
                            transactions = txs
                                .concat(txsP)
                                .sort(function (x, y) { return (moment(x.timestamp).isBefore(moment(y.timestamp)) ? 1 : -1); });
        ...
        updateAllTransactionHistory: function (_a) {
            var state = _a.state, rootState = _a.rootState, rootGetters = _a.rootGetters, dispatch = _a.dispatch;
            return __awaiter(this, void 0, void 0, function () {
                var wallet, network, avmAddrs, pvmAddrs, limit, txsX, txsP, txsXFiltered, txsPFiltered, transactions;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            wallet = rootState.activeWallet;
