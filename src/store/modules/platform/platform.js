...
var platform_module = {
    ...
    actions: {
        ...
        setValidatorName: function (state, nodeId) {
            return __awaiter(this, void 0, void 0, function () {
                var _a
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = state
                            return [4 /*yield*/, getNameValidator(nodeId)]
                        case 1:
                            _a.nameNodeId = _b.sent()
                            return [2 /*return*/]
                    }
                })
            })
        ...
        updateMinStakeAmount: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            return [4 /*yield*/, pChain.getMinStake(true)]
                        case 1:
                            res = _b.sent()
        ...
        updateValidators: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            return [4 /*yield*/, pChain.getCurrentValidators()]
                        case 1:
                            res = _b.sent()
                            validators = res.validators
                            commit('setValidatorName')
        ...
        updateValidatorsPending: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            return [4 /*yield*/, pChain.getPendingValidators()]
                        case 1:
                            res = _b.sent()
                            validators = res.validators
    ...
    getters: {
        validatorListEarn: function (state, getters) {
            ...
            var newStringNodeId = nameValidatorArray.toString()
        ...
        validatorMaxStake: function (state, getters) {
