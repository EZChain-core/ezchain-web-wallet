        ...
        accessWallet: function (_a, mnemonic) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            return [4 /*yield*/, dispatch('addWalletMnemonic', mnemonic)]
                        case 1:
                            wallet = _b.sent()
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 3:
                            ...
                            return [3 /*break*/, 6]
                        case 4:
                            return [4 /*yield*/, dispatch('addWalletSingleton', keyInfo.key)]
                        case 5:
                            _c.sent()
                            _c.label = 6
                        case 6:
                        ...
                        case 9:
                            return [
                                4 /*yield*/,
                                dispatch('activateWallet', state.wallets[activeIndex]),
                            ]
                        case 10:
                            _c.sent()
                            dispatch('onAccess')
        ...
        accessWalletSingleton: function (_a, key) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            return [4 /*yield*/, dispatch('addWalletSingleton', key)]
                        case 1:
                            wallet = _b.sent()
                            return [4 /*yield*/, dispatch('activateWallet', wallet)]
                        case 2:
        ...
        addWalletMnemonic: function (_a, mnemonic) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    ...
                    if (
                        ((_b = state.activeWallet) === null || _b === void 0 ? void 0 : _b.type) ===
                        'ledger'
                    )
                        return [
                            2 /*return*/,
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!wallet) return [2 /*return*/, 'error']
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!wallet_1) throw new Error('No active wallet.')
                            activeIndex = wallets.findIndex(function (w) {
                                return w.id == wallet_1.id
                            })
                            return [
                                4 /*yield*/,
                                makeKeyfile(wallets, pass, activeIndex),
                                // Download the file
                            ]
                        case 1:
                            file_data = _b.sent()
                            ...
                            filename = 'AVAX_' + dateString + '.json'
                            blob = new Blob([text], {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [
                                4 /*yield*/,
                                store.dispatch('accessWalletMultiple', {
                                    keys: keys,
        ...
        updateAvaxPrice: function (store) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, getAvaxPriceUSD()]
                        case 1:
                            usd = _a.sent()
                            store.state.prices = {
                                usd: usd,
