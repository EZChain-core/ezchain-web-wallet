        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fromAddrs = fromAddrsStr.map(function (val) {
                        return bintools.parseAddress(val, 'X')
                    })
                ...
                case 1:
                    ...
                    aad = new AssetAmountDestination([TO_BUF], fromAddrs, [changeAddr])
                    ZERO = new BN(0)
                    isFeeAdded = false
...
export function buildCreateNftFamilyTx(
    name,
    symbol,
    groupNum,
    fromAddrs,
...
export function buildEvmTransferNativeTx(
    from,
    to,
    amount, // in wei
    gasPrice,
...
export function buildEvmTransferErc20Tx(
    from,
    to,
    amount, // in wei
    gasPrice,
...
;(function (PlatfromTxNameEnum) {
    PlatfromTxNameEnum[(PlatfromTxNameEnum['Transaction'] = PlatformVMConstants.BASETX)] =
        'Transaction'
    PlatfromTxNameEnum[(PlatfromTxNameEnum['Add Validator'] = PlatformVMConstants.ADDVALIDATORTX)] =
        'Add Validator'
    PlatfromTxNameEnum[(PlatfromTxNameEnum['Add Delegator'] = PlatformVMConstants.ADDDELEGATORTX)] =
        'Add Delegator'
    ...
    PlatfromTxNameEnum[
        (PlatfromTxNameEnum['Add Subnet Validator'] = PlatformVMConstants.ADDSUBNETVALIDATORTX)
    ] = 'Add Subnet Validator'
    PlatfromTxNameEnum[(PlatfromTxNameEnum['Create Chain'] = PlatformVMConstants.CREATECHAINTX)] =
        'Create Chain'
    PlatfromTxNameEnum[(PlatfromTxNameEnum['Create Subnet'] = PlatformVMConstants.CREATESUBNETTX)] =
        'Create Subnet'
    PlatfromTxNameEnum[(PlatfromTxNameEnum['Advance Time'] = PlatformVMConstants.ADVANCETIMETX)] =
        'Advance Time'
    PlatfromTxNameEnum[
        (PlatfromTxNameEnum['Reward Validator'] = PlatformVMConstants.REWARDVALIDATORTX)
    ] = 'Reward Validator'
...
;(function (ParseablePlatformEnum) {
    ParseablePlatformEnum[(ParseablePlatformEnum['Transaction'] = PlatformVMConstants.BASETX)] =
        'Transaction'
    ParseablePlatformEnum[
        (ParseablePlatformEnum['Add Validator'] = PlatformVMConstants.ADDVALIDATORTX)
    ] = 'Add Validator'
    ParseablePlatformEnum[
        (ParseablePlatformEnum['Add Delegator'] = PlatformVMConstants.ADDDELEGATORTX)
    ] = 'Add Delegator'
    ParseablePlatformEnum[(ParseablePlatformEnum['Import'] = PlatformVMConstants.IMPORTTX)] =
        'Import'
    ParseablePlatformEnum[(ParseablePlatformEnum['Export'] = PlatformVMConstants.EXPORTTX)] =
        'Export'
