        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [3 /*break*/, 11]
                case 1:
                    return [4 /*yield*/, readV6(data, pass)]
                case 2:
                    return [2 /*return*/, _b.sent()]
                case 3:
                    return [4 /*yield*/, readV5(data, pass)]
                case 4:
                    return [2 /*return*/, _b.sent()]
                case 5:
                    return [4 /*yield*/, readV4(data, pass)]
                case 6:
                    return [2 /*return*/, _b.sent()]
                case 7:
                    return [4 /*yield*/, readV3(data, pass)]
                case 8:
                    return [2 /*return*/, _b.sent()]
                case 9:
                    return [4 /*yield*/, readV2(data, pass)]
                case 10:
                    return [2 /*return*/, _b.sent()]
                case 11:
...
function extractKeysV5(file) {
    return file.keys.map(function (key) {
        return {
            key: key.key,
            type: 'mnemonic',
        }
