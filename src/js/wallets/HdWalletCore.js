...
var HdWalletCore = /** @class */ (function (_super) {
    ...
    HdWalletCore.prototype.getEvmAddressBech = function () {
        return bintools.addressToString(ava.getHRP(), 'C', 
        // @ts-ignore
    ...
    HdWalletCore.prototype.updateUTXOsExternal = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.externalHelper.updateUtxos()];
                    case 1:
                        res = _a.sent();
    ...
    HdWalletCore.prototype.updateUTXOsInternal = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.internalHelper.updateUtxos()];
                    case 1:
                        utxoSet = _a.sent();
                        this.updateFetchState();
                        this.updateAvmUTXOSet();
    ...
    HdWalletCore.prototype.updateUTXOsP = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.platformHelper.updateUtxos()];
                    case 1:
                        utxoSet = _a.sent();
                        this.updateFetchState();
                        return [2 /*return*/];
    ...
    HdWalletCore.prototype.signMessage = function (msg, address) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.signMessageByExternalAddress(msg, address)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
