...
var SingletonWallet = /** @class */ (function (_super) {
    ...
    SingletonWallet.prototype.updateUTXOsX = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, avmGetAllUTXOs([this.getCurrentAddressAvm()])]
                    case 1:
                        result = _a.sent()
                        this.utxoset = result
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            platformGetAllUTXOs([this.getCurrentAddressPlatform()]),
                        ]
                    case 1:
                        result = _a.sent()
    ...
    SingletonWallet.prototype.validate = function (
        nodeID,
        amt,
        start,
        end,
