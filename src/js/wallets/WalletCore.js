...
var WalletCore = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, cChain.buildImportTx(utxoSet, toAddress, ownerAddresses, sourceChainId, fromAddresses, fee)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        amtFee = amt.clone();
                        destinationAddr = destinationChain === 'P' ? this.getCurrentAddressPlatform() : this.getEvmAddressBech();
                        ...
                        return [4 /*yield*/, TxHelper.buildAvmExportTransaction(destinationChain, utxos, fromAddresses, destinationAddr, amtFee, changeAddress)];
                    case 1:
                        exportTx = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        destinationAddr = destinationChain === 'C' ? this.getEvmAddressBech() : this.getCurrentAddressAvm();
                        return [4 /*yield*/, TxHelper.buildPlatformExportTransaction(utxoSet, fromAddrs, destinationAddr, amtFee, pChangeAddr, destinationChain)];
                    case 1:
                        exportTx = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        destinationAddr = destinationChain === 'X'
                            ? this.getCurrentAddressAvm()
                            : this.getCurrentAddressPlatform();
                        return [4 /*yield*/, TxHelper.buildEvmExportTransaction(fromAddresses, destinationAddr, amtFee, bechAddr, destinationChain, exportFee)];
                    case 1:
                        exportTx = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                destinationAddr = destinationChain === 'X'
                    ? this.getCurrentAddressAvm()
                    : this.getCurrentAddressPlatform();
                return [2 /*return*/, GasHelper.estimateExportGasFee(destinationChain, hexAddr, bechAddr, destinationAddr, amount)];
            });
        });
    };
    ...
    WalletCore.prototype.importToPlatformChain = function (sourceChain) {
        return __awaiter(this, void 0, void 0, function () {
            var utxoSet, sourceChainId, pToAddr, hrp, utxoAddrs, fromAddrs, ownerAddrs, unsignedTx, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.platformGetAtomicUTXOs(sourceChain)];
                    case 1:
                        utxoSet = _a.sent();
                        if (utxoSet.getAllUTXOs().length === 0) {
                            throw new Error('Nothing to import.');
                        ...
                        utxoAddrs = utxoSet
                            .getAddresses()
                            .map(function (addr) { return bintools.addressToString(hrp, 'P', addr); });
                        fromAddrs = utxoAddrs;
                        ownerAddrs = utxoAddrs;
                        return [4 /*yield*/, pChain.buildImportTx(utxoSet, ownerAddrs, sourceChainId, [pToAddr], [pToAddr], [pToAddr], undefined, undefined)];
                    case 2:
                        unsignedTx = _a.sent();
    ...
    WalletCore.prototype.importToXChain = function (sourceChain) {
        return __awaiter(this, void 0, void 0, function () {
            var utxoSet, xToAddr, hrp, utxoAddrs, fromAddrs, ownerAddrs, sourceChainId, unsignedTx, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.avmGetAtomicUTXOs(sourceChain)];
                    case 1:
                        utxoSet = _a.sent();
                        if (utxoSet.getAllUTXOs().length === 0) {
                            throw new Error('Nothing to import.');
                        ...
                        utxoAddrs = utxoSet
                            .getAddresses()
                            .map(function (addr) { return bintools.addressToString(hrp, 'X', addr); });
                        fromAddrs = utxoAddrs;
                        ownerAddrs = utxoAddrs;
                        sourceChainId = Network.chainIdFromAlias(sourceChain);
                        return [4 /*yield*/, avm.buildImportTx(utxoSet, ownerAddrs, sourceChainId, [xToAddr], fromAddrs, [xToAddr])];
                    case 2:
                        unsignedTx = _a.sent();
