...
import { AVMConstants, SelectCredentialClass as AVMSelectCredentialClass, Tx as AVMTx, } from 'ezchainjs2/dist/apis/avm';
import { ImportTx as PlatformImportTx, Tx as PlatformTx, PlatformVMConstants, SelectCredentialClass as PlatformSelectCredentialClass, AddDelegatorTx, } from 'ezchainjs2/dist/apis/platformvm';
import { ImportTx as EVMImportTx, Tx as EvmTx, EVMConstants, SelectCredentialClass as EVMSelectCredentialClass, } from 'ezchainjs2/dist/apis/evm';
...
var LedgerWallet = /** @class */ (function (_super) {
    ...
    LedgerWallet.fromApp = function (app, eth, config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, app.getWalletExtendedPublicKey(AVA_ACCOUNT_PATH)];
                    case 1:
                        res = _a.sent();
                        hd = new HDKey();
    ...
    LedgerWallet.prototype.signTransactionHash = function (unsignedTx, paths, chainId) {
        return __awaiter(this, void 0, void 0, function () {
            var txbuff, msg, bip32Paths, accountPathSource, accountPath, sigMap, creds, signedTx, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    LedgerWallet.prototype.signTransactionParsable = function (unsignedTx, paths, chainId) {
        return __awaiter(this, void 0, void 0, function () {
            var tx, txType, parseableTxs, title, bip32Paths, accountPath, txbuff, changePath, messages, ledgerSignedTx, sigMap, creds, signedTx, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.app.signTransaction(accountPath, bip32Paths, txbuff, changePath)];
                    case 2:
    ...
    LedgerWallet.prototype.getOutputMsgs = function (unsignedTx, chainId, changePath) {
        ...
        // @ts-ignore
        var outs;
        if ((txType === AVMConstants.EXPORTTX && chainId === 'X') ||
        ...
        if (destinationChain === 'C') {
            ...
            var changeIdx = changePath === null || changePath === void 0 ? void 0 : changePath.toPathArray()[(changePath === null || changePath === void 0 ? void 0 : changePath.toPathArray().length) - 1];
    ...
    LedgerWallet.prototype.getValidateDelegateMsgs = function (unsignedTx, chainId) {
        ...
        var txType = tx.getTxType();
        var messages = [];
        if ((txType === PlatformVMConstants.ADDDELEGATORTX && chainId === 'P') ||
    ...
    LedgerWallet.prototype.getFeeMsgs = function (unsignedTx, chainId) {
        ...
        var txType = tx.getTxType();
        var messages = [];
        if ((txType === AVMConstants.BASETX && chainId === 'X') ||
    ...
    LedgerWallet.prototype.getEvmTransactionMessages = function (tx) {
        ...
        try {
            ...
            var feeMsg = {
                title: 'Fee',
                value: feeNano.toLocaleString() + ' nEZC',
            };
    ...
    LedgerWallet.prototype.signP = function (unsignedTx) {
        return __awaiter(this, void 0, void 0, function () {
            var tx, txType, chainId, parseableTxs, _a, paths, isAvaxOnly, canLedgerParse, isParsableType, txIns, i, typeID, destChainBuff, destChain, sourceChainBuff, sourceChain, signedTx;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        tx = unsignedTx.getTransaction();
                        ...
                        if (txType === PlatformVMConstants.IMPORTTX) {
                            ...
                            sourceChain = Network.idToChainAlias(bintools.cb58Encode(sourceChainBuff));
                            if (sourceChain === 'C') {
                                canLedgerParse = false;
                            }
                        }
    ...
    LedgerWallet.prototype.signC = function (unsignedTx) {
        return __awaiter(this, void 0, void 0, function () {
            var tx, typeId, canLedgerParse, paths, ins, ins, destChainBuff, destChain, sourceChainBuff, sourceChain, txSigned;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tx = unsignedTx.getTransaction();
                        ...
                        if (typeId === EVMConstants.EXPORTTX) {
                            ins = tx.getInputs();
                            paths = ins.map(function (input) { return '0/0'; });
                        }
                    ...
                    case 1:
                        txSigned = (_a.sent());
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.signTransactionHash(unsignedTx, paths, 'C')];
                    case 3:
                        txSigned = (_a.sent());
                        _a.label = 4;
                    case 4:
    ...
    LedgerWallet.prototype.signEvm = function (tx) {
        return __awaiter(this, void 0, void 0, function () {
            var rawUnsignedTx, msgs, signature, signatureBN, chainId, networkId, chainParams, signedTx, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.ethApp.signTransaction(LEDGER_ETH_ACCOUNT_PATH, rawUnsignedTx.toString('hex'))];
                    case 2:
                        signature = _a.sent();
                        store.commit('Ledger/closeModal');
                        signatureBN = {
                    ...
                    case 4:
                        ...
                        signedTx = Transaction.fromTxData(__assign({ nonce: tx.nonce, gasPrice: tx.gasPrice, gasLimit: tx.gasLimit, to: tx.to, value: tx.value, data: tx.data }, signatureBN), chainParams);
                        return [2 /*return*/, signedTx];
                    case 5:
                        e_3 = _a.sent();
                        store.commit('Ledger/closeModal');
    ...
    LedgerWallet.prototype.validate = function (nodeID, amt, start, end, delegationFee, rewardAddress, utxos) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
