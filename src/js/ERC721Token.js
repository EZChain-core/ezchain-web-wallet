...
var ERC721Token = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.contract.methods.supportsInterface(ERC721MetadataID).call()];
                    case 1:
                        metadata = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.contract.methods.tokenOfOwnerByIndex(address, i).call()];
                    case 3:
                        tokenId = _a.sent();
                        res.push(tokenId);
                        _a.label = 4;
    ...
    ERC721Token.prototype.getAllTokenData = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAllTokensIds(address)];
                    case 1:
                        ids = _a.sent();
                        res = [];
                        i = 0;
    ...
    ERC721Token.prototype.getTokenURI = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.tokenCache[id])
                            return [2 /*return*/, this.tokenCache[id]];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        //Check cache
                        if (this.uriDataCache[id])
                            return [2 /*return*/, this.uriDataCache[id]];
