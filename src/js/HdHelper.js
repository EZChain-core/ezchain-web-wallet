...
import { KeyChain as AVMKeyChain, KeyPair as AVMKeyPair, UTXOSet as AVMUTXOSet, } from 'ezchainjs2/dist/apis/avm';
...
var HdHelper = /** @class */ (function () {
    ...
    HdHelper.prototype.oninit = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findHdIndex()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, platformGetAllUTXOs(addrs)];
                    case 3:
                        result = _a.sent();
                        _a.label = 4;
                    case 4:
    ...
    HdHelper.prototype.getAllDerivedKeys = function (upTo) {
        if (upTo === void 0) { upTo = this.hdIndex; }
        var set = [];
    ...
    HdHelper.prototype.findAvailableIndexExplorer = function (startIndex) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var upTo, addrs, addrChains, chainID, i, gapSize, n, scanIndex, scanAddr, rawAddr, chains;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        upTo = 512;
    ...
    HdHelper.prototype.findAvailableIndexNode = function (start) {
        if (start === void 0) { start = 0; }
        return __awaiter(this, void 0, void 0, function () {
            var addrs, i, address, utxoSet, i, gapSize, n, scanIndex, addr, addrBuf, addrUTXOs, targetIndex;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        addrs = [];
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, pChain.getUTXOs(addrs)];
                    case 3:
                        utxoSet = (_a.sent()).utxos;
                        _a.label = 4;
                    case 4:
