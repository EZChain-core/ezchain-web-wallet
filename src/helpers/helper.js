...
function calculateStakingReward(amount, duration, currentSupply) {
    return __awaiter(this, void 0, void 0, function () {
        var result, networkID, defValues, _amount, _currentSupply, defPlatformVals, maxSupply, remainingSupply, totalOfStake, num;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pChain.getTotalOfStake()];
                case 1:
                    result = _a.sent();
                    ...
                    num = reward(duration, _amount, parseInt(totalOfStake.toString()), remainingSupply);
                    return [2 /*return*/, num];
            }
        });
    });
...
function convert(n) {
    ...
    var _a = __read(data, 3), lead = _a[0], decimal = _a[1], pow = _a[2];
    if (+pow < 0) {
...
function getNameValidator(Node_ids) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios.get("https://api.ezchain.com/v1/service/validators?node_ids=" + Node_ids)];
                case 1:
...
export { keyToKeypair, calculateStakingReward, bnToBig, digestMessage, getPayloadFromUTXO, getNameValidator, };
