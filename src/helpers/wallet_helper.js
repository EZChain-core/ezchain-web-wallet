...
import { buildCreateNftFamilyTx, buildEvmTransferErc20Tx, buildEvmTransferErc721Tx, buildEvmTransferNativeTx, buildMintNftTx, } from '@/js/TxHelper';
...
var WalletHelper = /** @class */ (function () {
    ...
    WalletHelper.issueBatchTx = function (wallet, orders, addr, memo) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, wallet.buildUnsignedTransaction(orders, addr, memo)];
                    case 1:
                        unsignedTx = _a.sent();
                        return [4 /*yield*/, wallet.signX(unsignedTx)];
                    case 2:
    ...
    WalletHelper.validate = function (wallet, nodeID, amt, start, end, delegationFee, rewardAddress, utxos) {
        return __awaiter(this, void 0, void 0, function () {
            var utxoSet, pAddressStrings, stakeAmount, changeAddress, stakeReturnAddr, startTime, endTime, unsignedTx, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    WalletHelper.delegate = function (wallet, nodeID, amt, start, end, rewardAddress, utxos) {
        return __awaiter(this, void 0, void 0, function () {
            var utxoSet, pAddressStrings, stakeAmount, stakeReturnAddr, changeAddress, startTime, endTime, unsignedTx, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        utxoSet = wallet.getPlatformUTXOSet();
    ...
    WalletHelper.getEthBalance = function (wallet) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, web3.eth.getBalance(wallet.ethAddress)];
                    case 1:
                        bal = _a.sent();
    ...
    WalletHelper.sendEth = function (wallet, to, amount, // in wei
    gasPrice, gasLimit) {
        return __awaiter(this, void 0, void 0, function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fromAddr = '0x' + wallet.getEvmAddress();
                        return [4 /*yield*/, buildEvmTransferErc20Tx(fromAddr, to, amount, gasPrice, gasLimit, token)];
                    case 1:
                        tx = _a.sent();
                        return [4 /*yield*/, wallet.signEvm(tx)];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fromAddr = '0x' + wallet.getEvmAddress();
                        return [4 /*yield*/, buildEvmTransferErc721Tx(fromAddr, to, gasPrice, gasLimit, token, tokenId)];
                    case 1:
                        tx = _a.sent();
                        return [4 /*yield*/, wallet.signEvm(tx)];
                    case 2:
