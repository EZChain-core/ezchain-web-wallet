...
export function getAvaxPriceUSD() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios.get('https://price.ezchain.com/v1/service/token?symbol=ezc')];
                case 1:
                    res = _a.sent();
                    if (res.data.data)
                        return [2 /*return*/, Number(res.data.data.current_price)];
                    return [2 /*return*/, 1];
            }
        });
    });
...
function getPriceHistory() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, coingeckoApi.get("/coins/" + COIN_ID + "/market_chart", {
                        params: {
                            vs_currency: 'usd',
                            days: 'max',
                            interval: 'daily',
